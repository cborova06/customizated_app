    ...
    $(dialog.body).html(
      `<div>
				...
				<p>
					...
					${__("Website")}:
					<a href='https://www.brvsoftware.com.tr/' target='_blank'>https://www.brvsoftware.com.tr/</a>
				</p>

				<p>
					<i class='fa fa-file-text fa-fw'></i>
					${__("BRVSoftware Blog")}:
					<a href='https://www.brvsoftware.com.tr/blog/' target='_blank'>https://www.brvsoftware.com.tr/blog/</a>
				</p>
				...
				<p>
					...
					${__("LinkedIn")}:
					<a href='https://www.linkedin.com/company/brv-software' target='_blank'>https://www.linkedin.com/company/brv-software</a>
				</p>
				...
				<p class='text-muted'>${__("&copy; BRV Software")} </p>
			</div>`
    );
